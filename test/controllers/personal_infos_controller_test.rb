...
class PersonalInfosControllerTest < ActionController::TestCase
  ...
  test "should create personal_info" do
    assert_difference('PersonalInfo.count') do
      post :create, personal_info: { birthday: @personal_info.birthday, first_name: @personal_info.first_name, gender: @personal_info.gender, last_name: @personal_info.last_name, mobile: @personal_info.mobile, tel: @personal_info.tel }
    end
  ...
  test "should update personal_info" do
    patch :update, id: @personal_info, personal_info: { birthday: @personal_info.birthday, first_name: @personal_info.first_name, gender: @personal_info.gender, last_name: @personal_info.last_name, mobile: @personal_info.mobile, tel: @personal_info.tel }
    assert_redirected_to personal_info_path(assigns(:personal_info))
  end
